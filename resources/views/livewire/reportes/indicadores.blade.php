                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="card-new">
                                    ...
                                    <div class="data">
                                        ...
                                        <div class="range">
                                            <div class="fill" id="rangeIndicador" style="background-color: #D22FEC; width:0%">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card-new">
                                    <div class="title">
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><circle cx="7.2" cy="14.4" r="3.2" fill="#ededed"/><circle cx="14.8" cy="18" r="2" fill="#ededed"/><circle cx="15.2" cy="8.8" r="4.8" fill="#ededed"/></svg>
                                        </span>
                                        <p class="title-text">
                                            Hitos
                                        </p>
                                ...
                                <div class="card-new">
                                    <div class="title">
                                        <span style="background-color: #FDFD5E">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#cfc4c4" d="M2 2h2v18h18v2H2V2m5 8h10v3H7v-3m4 5h10v3H11v-3M6 4h16v4h-2V6H8v2H6V4Z"/></svg>
                                        </span>
                                        <p class="title-text">
                                            Fases
                                        </p>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card-new">
                                    ...
                                    <div class="data">
                                        ...
                                        <div class="range">
                                            <div class="fill" id="rangeMetodologia" style="background-color: #FC6B3D;width:0%">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-new">
                                    <div class="title">
                                        <span style="background-color: #FD5B79">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="#ffffff" d="M8 16h2V8H8v8Zm4 0l6-4l-6-4v8Zm0 6q-2.075 0-3.9-.788t-3.175-2.137q-1.35-1.35-2.137-3.175T2 12q0-2.075.788-3.9t2.137-3.175q1.35-1.35 3.175-2.137T12 2q2.075 0 3.9.788t3.175 2.137q1.35 1.35 2.138 3.175T22 12q0 2.075-.788 3.9t-2.137 3.175q-1.35 1.35-3.175 2.138T12 22Zm0-2q3.35 0 5.675-2.325T20 12q0-3.35-2.325-5.675T12 4Q8.65 4 6.325 6.325T4 12q0 3.35 2.325 5.675T12 20Zm0-8Z"/></svg>
                                        </span>
                                        <p class="title-text">
                                            Proyectos Iniciados
                                        </p>
                                    ...
                                    <div class="data">
                                        ...
                                        <div class="range">
                                            <div class="fill" id="proyectoIni" style="background-color: #FD5B79;width:0%">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-new">
                                    <div class="title">
                                        <span style="background-color: #5B98FD">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 100 100"><path fill="#fcfcfc" d="M50 0a3.5 3.5 0 0 0-3.5 3.5V93h-9.57a3.5 3.5 0 0 0-3.5 3.5a3.5 3.5 0 0 0 3.5 3.5h25a3.5 3.5 0 0 0 3.5-3.5a3.5 3.5 0 0 0-3.5-3.5H53.5V47h43a3.5 3.5 0 0 0 3.5-3.5v-40A3.5 3.5 0 0 0 96.5 0h-46a3.5 3.5 0 0 0-.254.01A3.5 3.5 0 0 0 50 0zm13.8 7h9.8v7.43h9.8V7H93v7.43h-9.6v9.799H93v9.8h-9.6V40h-9.8v-5.97h-9.8V40H54v-5.97h9.8v-9.801H54v-9.8h9.8V7zm0 7.43v9.799h9.8v-9.8h-9.8zm9.8 9.799v9.8h9.8v-9.8h-9.8z" color="#fcfcfc"/></svg>
                                        </span>
                                        <p class="title-text">
                                    ...
                                    <div class="data">
                                        ...
                                        <div class="range">
                                            <div class="fill" id="proyectoFin" style="background-color: #5B98FD; width:0%">
                                            </div>
                                        </div>
                                    </div>
                                </div>
