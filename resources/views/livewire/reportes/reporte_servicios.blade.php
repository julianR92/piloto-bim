...
@section('content')
            ...
            <div class="py-4">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Reporte de Servcicios</li>
                    </ol>
                </nav>
                <div class="d-flex justify-content-between w-100 flex-wrap">
                    <div class="mb-3 mb-lg-0">
                        <h1 class="h4">Reportes de Servicios</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group mb-2 col-md-4">
                            <label for="servicio_id">Servicios Adicionales</label>
                            <div>
                                <div class="input-group">
    ...
    @push('scripts-reportes')
        <script src="{{ asset('js/reporte-servicios.js') }}" type="module"></script>
    @endpush
@endsection
