    ...
    <div class="py-4">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Comision Procedimientos</li>
            </ol>
        </nav>
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Comision de Procedimientos</h1>
            </div>             
        </div>
    </div>
        ...
        <div class="card-body">
                ...
                <table class="table table-centered table-nowrap mb-0 rounded d-none" id="myTableWeekly">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="border-0 rounded-start">Talla</th>
            ...
            <div class="col-md-8">
                <div class="form-group mb-2 mt-3 divValorGanado d-none">
                    ...
                    <label for="presentacion"><h3>Valor Comision:</h3><span id="total_cuenta" class="total-factura"></span></label>
                    <div>                      
                    </div>
                </div>
            </div>
