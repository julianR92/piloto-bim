...
@section('content')
            ...
            <div class="py-4">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Reporte de Procedimientos</li>
                    </ol>
                </nav>
                <div class="d-flex justify-content-between w-100 flex-wrap">
                    <div class="mb-3 mb-lg-0">
                        <h1 class="h4">Reportes de Procedimientos</h1>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group mb-2 col-md-3">
                            ...
                            <div>
                                <div class="input-group">
                                    <select name="profesional_id" id="profesional_id" class="form-control form-select">
                                        <option value="">Seleccione..</option>
                        ...
                        <div class="form-group mb-2 col-md-3">
                            <label for="talla_id">Tallas</label>
                            <div>
                                <div class="input-group">
                                    <select name="talla_id" id="talla_id" class="form-control form-select" >
                                        <option value="">Seleccione..</option>
                        ...
                        <div class="form-group mb-2 col-md-3">
                            ...
                            <div>
                                <div class="input-group">
                                    <select name="descuento_id" id="descuento_id" class="form-control form-select" >
                                        <option value="">Seleccione..</option>
                                        @foreach ($descuentos as $descuento)
                                            <option value="{{ $descuento->id }}">{{ $descuento->plan }}
                                                </option>
                                        @endforeach
                                    </select>
                                    @error('descuento_id')
                        ...
                        <div class="form-group mb-2 col-md-2 mt-1">
                            <a type="button" class="btn btn-success text-white mt-4 btnBuscar">
                                <svg xmlns="http://www.w3.org/2000/svg" class="btnBuscar" width="16" height="16" viewBox="0 0 24 24">
                                    <path  class="btnBuscar" fill="currentColor"
                    ...
                    <div class="table-responsive mt-3">
                        <table class="table table-centered table-nowrap mb-0 rounded d-none" id="myTable" data-search="true" data-pagination="true" data-page-size="15" >
                            <thead class="thead-light">
                                <tr>
                             <th class="border-0 rounded-start">#</th>
                            <th data-field="procedimiento" class="border-0">Procedimiento</th>
                            ...
                            <th class="border-0">Profesionales</th>
                            <th class="border-0">Abono</th>
                            <th class="border-0">Valor Pagado</th>                                 
                    ...
                    <div class="row justify-content-end">
                        <div class="col-md-2 d-none divSalida mt-3">
                            <button type="button" class="btn btn-gray-200 d-inline-flex align-items-right btnSalir">
                                <svg xmlns="http://www.w3.org/2000/svg" class="btnSalir" width="24" height="24" viewBox="0 0 24 24">
                                    <path  class="btnSalir" fill="currentColor"
    ...
    @push('scripts-reportes')
        <script src="{{ asset('js/reporte-procedimientos.js') }}" type="module"></script>
    @endpush
@endsection
