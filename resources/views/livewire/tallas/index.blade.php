    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Administración de tallas</h1>
            </div>   
            <div>
                    ...
                    <tbody id="tbodyColectivo">
                        @foreach($tallas as $talla)
                         <tr>
                            ...
                            <td>{{$talla->talla}}</td>                          
                            <td>
                            <button type="button" class="btn btn-success d-inline-flex align-items-center editarData" data-id="{{$talla->id}}">
                            ...
                            <button type="button" class="btn btn-danger d-inline-flex align-items-center eliminarData" data-id="{{$talla->id}}">
...
<script src="{{asset('js/tallas.js')}}" type="module"></script>
@endpush
