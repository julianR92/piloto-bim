                ...
                <div class="col-md-6 col-lg-6 col-sm-12 d-flex align-items-center">
                    <div class="bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            <h1 class="mb-3 h3 text-info" style="font-weight:800">Ingresar a la Plataforma</h1>
                        ...
                        <form wire:submit.prevent="login" action="#" class="mt-4" method="POST" id="login-form">
                            <!-- Form -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex justify-content-between align-items-top mb-4">
                                    ...
                                    <div><a href="{{ route('forgot-password') }}"
                                            class="small text-right text-info">¿Olvidaste tu contraseña?
                                        </a></div>
                                </div>
                            </div>
                            <div class="d-grid">
                                <button type="submit" class="btn btn-info">Conectar</button>
                            </div>
                        </form>
                        ...
                        <div class="d-flex justify-content-center align-items-center mt-4">
                            <span class="fw-normal">
                                ¿ No tienes usuario?
                                <a href="{{ route('register') }}" class="fw-bold text-info">Registrarse</a>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <h1 class="h3 text-info text-center" style="font-weight:800">Bienvenido a la Plataforma Piloto BIM
                    </h1>

                    <img src="{{ asset('assets/img/login.png') }}" alt="Banner" width="80%"
                        style="margin-left:50px;" class="img-fluid" />
