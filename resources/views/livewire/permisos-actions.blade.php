<div>
    <button type="button" wire:click="$emitTo('permission','editPermission', {{ $row->id }})" class="btn btn-success d-inline-flex align-items-center">
    ...
    <button type="button" wire:click="$emit('eliminarJs', {{ $row->id }})" class="btn btn-danger d-inline-flex align-items-center">
        ...
        <script>
             Livewire.on('eliminarJs', ($permiso) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.emitTo('permission', 'eliminar', $permiso);
                        Swal.fire(
                            'Registro eliminado!',
