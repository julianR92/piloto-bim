<div>
    ...
    <button type="button" wire:click="$emitTo('areas.areas','editPermission', {{ $row->id }})" class="btn btn-success d-inline-flex align-items-center">
            ...
            Livewire.on('eliminarJs', ($area) => {
               ...
               Swal.fire({
                   ...
                   if (result.isConfirmed) {
                       ...
                       Livewire.emitTo('areas.areas', 'eliminar', $area);
